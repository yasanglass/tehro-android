...
val vazirFamily = FontFamily(
    Font(R.font.vazir_black_ui, FontWeight.Black, FontStyle.Normal),
    Font(R.font.vazir_bold_ui, FontWeight.Bold, FontStyle.Normal),
    Font(R.font.vazir_light_ui, FontWeight.Light, FontStyle.Normal),
    Font(R.font.vazir_medium_ui, FontWeight.Medium, FontStyle.Normal),
    Font(R.font.vazir_regular_ui, FontWeight.Normal, FontStyle.Normal),
    Font(R.font.vazir_thin_ui, FontWeight.Thin, FontStyle.Normal),
)